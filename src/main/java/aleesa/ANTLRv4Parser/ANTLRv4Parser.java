...
public class ANTLRv4Parser extends Parser {
	...
	public static class LexerRuleBlockContext extends ParserRuleContext {
		...
		public String getRegex(){
		    return lexerAltList().getRegex();
        }

        public ArrayList<String> getRegexList(){
//            ArrayList<String> tmp = new ArrayList<>();
//            return tmp;
            return lexerAltList().getRegexList();
        }
	}
	...
	public static class LexerAltListContext extends ParserRuleContext {
		...
		public String getRegex(){
			String newStr = "";
			for(LexerAltContext x :lexerAlt()){
				newStr += x.getRegex()+"|";
			}
	...
	public static class LexerAltContext extends ParserRuleContext {
		...
		public String getRegex(){
			return lexerElements().getRegex();
		}

        public ArrayList<String> getRegexList(){
            ArrayList<String> tmp;
            if (lexerElements() != null) {
                tmp = lexerElements().getRegexList();
            } else {
                tmp = new ArrayList<String>();
            }

            if (lexerCommands() != null) {
                for (String x : lexerCommands().getRegexList()) {
                    tmp.add(x);
                }
                return tmp;
            }
	...
	public static class LexerElementsContext extends ParserRuleContext {
		...
		public String getRegex(){
			String regex = "";
			for(LexerElementContext x:lexerElement()){
				regex += x.getRegex();
			}
			return regex;
		}
    ...
    */
    public static class LexerElementContext extends ParserRuleContext {
        ...
        public String getRegex(){
            if(lexerAtom() != null){
                String str = lexerAtom().getRegex().replaceAll("\\.", "[\\s\\S]");
                //System.out.println(lexerAtom().getRegex() + " " + str);
                if(ebnfSuffix() != null){
                    return str + ebnfSuffix().getText();
                }
                return str;
            }else if(lexerBlock() != null){
                return lexerBlock().getRegex();
            }
            return "[LexerElementNull]";
        }

        public ArrayList<String> getRegexList(){
            if(lexerAtom() != null){
                if(ebnfSuffix() != null){
                    ArrayList<String> tmp = lexerAtom().getRegexList();
                    tmp.add(ebnfSuffix().getText());
                    return tmp;
                }
                return lexerAtom().getRegexList();
            }else if(lexerBlock() != null){
				if(ebnfSuffix() != null){
					ArrayList<String> tmp = lexerBlock().getRegexList();
					tmp.add(ebnfSuffix().getText());
					return tmp;
				}
                return lexerBlock().getRegexList();
            }
	...
	public static class LexerBlockContext extends ParserRuleContext {
        ...
        public ArrayList<String> getRegexList(){
            ArrayList<String> tmp = new ArrayList<>();
            tmp.add("(");
            for(String y:lexerAltList().getRegexList()){
                tmp.add(y);
            }
            tmp.add(")");
            return tmp;
	...
	public static class LexerCommandsContext extends ParserRuleContext {
		...
		public ArrayList<String> getRegexList(){
		    ...
		    ArrayList<String> tmp = new ArrayList<>();
		    for(LexerCommandContext lmc:lexerCommand()) {
                for(String x:lmc.getRegexList()){
                    tmp.add("->"+x);
                }
            }
		    return tmp;
	...
	public static class LexerAtomContext extends ParserRuleContext {
		...
		public String getRegex(){
			if(notSet() != null){
				return notSet().getRegex();
			}else if(terminal() != null){
				return terminal().getRegex();
            }else if(DOT() != null){
			    return DOT().getText();
            }else if(characterRange() != null){
                return characterRange().getRegex();
            }else if(LEXER_CHAR_SET() != null){
			    return LEXER_CHAR_SET().getText();
            }
			return "[LexerAtomNull]";
		}

        public ArrayList<String> getRegexList(){
            if(notSet() != null){
                return notSet().getRegexList();
            }else if(terminal() != null){
                return terminal().getRegexList();
            }else if(DOT() != null){
                ArrayList<String> tmp = new ArrayList<>();
                tmp.add(DOT().getText());
                return tmp;
                ...
                ArrayList<String> tmp = new ArrayList<>();
                tmp.add(characterRange().getRegex());
                return tmp;
            }else if(LEXER_CHAR_SET() != null){
                ArrayList<String> tmp = new ArrayList<>();
                tmp.add(LEXER_CHAR_SET().getText());
                return tmp;
            }
            return null;
	...
	public static class NotSetContext extends ParserRuleContext {
        ...
        public ArrayList<String> getRegexList(){
            ...
            tmp.add("((?!");
            if (setElement() != null) {
				tmp.add(setElement().getRegex());
            }else if(blockSet() != null){
            	for(String x:blockSet().getRegexList()){
            		tmp.add(x);
				}
			}
            tmp.add(")[\\s\\S])");
	...
	public static class BlockSetContext extends ParserRuleContext {
		...
		public ArrayList<String> getRegexList(){
			...
			tmp.add("(");
			boolean is = false;
			for(SetElementContext x:setElement()){
				if(is) tmp.add("|");
				is = true;
				tmp.add(x.getRegex());
			}
	...
	public static class SetElementContext extends ParserRuleContext {
		...
		public String getRegex(){
			if(LEXER_CHAR_SET() != null){
				return LEXER_CHAR_SET().getText();
            } else if (STRING_LITERAL() != null) {
                String str = STRING_LITERAL().getText();
                String newStr = "";
                ...
                return characterRange().getRegex();
            } else if (TOKEN_REF() != null) {
                return TOKEN_REF().getText();
            }
			return "";
		}
	}
	...
	public static class CharacterRangeContext extends ParserRuleContext {
        ...
        public String getRegex() {
            ...
            if (STRING_LITERAL().size() < 2) {
                //System.out.println("Error: CharacterRange " + getText());
                return "";
            }
            String zero = STRING_LITERAL(0).getText();
            zero = zero.substring(1, zero.length() - 1);
            String one = STRING_LITERAL(1).getText();
	...
	public static final String _serializedATN =
		...
		"--\3\2\3\4\u02aa\2\u0083\3\2\2\2\4\u009d\3\2\2\2\6\u00a4\3\2\2\2\b\u00a6"+
